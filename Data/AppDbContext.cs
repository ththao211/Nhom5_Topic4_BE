    ...
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            (
                ...
                new ReputationRule { RuleID = 15, RuleName = "Reward_Reviewer_Perfect_Reject_Streak", Value = 10, Category = "Reward", Description = "Thưởng Reviewer reject streak task liên tiếp không bị khiếu nại sai" }
            );
